...
sudo -u postgres /usr/lib/postgresql/%PGSQL_VERSION%/bin/initdb -D /data/$PGDIR && \
sudo -u postgres /usr/lib/postgresql/%PGSQL_VERSION%/bin/pg_ctl -D /data/$PGDIR start && \
...
sudo -u postgres /usr/lib/postgresql/%PGSQL_VERSION%/bin/pg_ctl -D /data/$PGDIR stop && \
